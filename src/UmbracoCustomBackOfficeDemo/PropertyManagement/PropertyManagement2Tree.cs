...
{
    [Tree("propertyManagement", "propertyManagement2", "Property Management 2")]
    public class PropertyManagement2Tree : BaseTree
    {
        public PropertyManagement2Tree(string application) : base(application) { }
